...
def decodage_brut(phrase):
    ...
    dico = open(r"mini projet\Français.txt") #ouvre un fichier texte situé au chemin spécifié et affecte son contenu à la variable 'dico'. Ce fichier texte sera utilisé 
