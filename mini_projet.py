...
def decodage_brut(phrase):
  ...
  dico = open(r"mini_projet\Français.txt")  #ouvre un fichier texte situé au chemin spécifié et affecte son contenu à la variable 'dico'. Ce fichier texte sera utilisé comme un dictionnaire pour vérifier si la phrase décodée contient des mots valides.
  ...
  while decalage <= 256:  #démarre une boucle while qui va itérer 256 fois. La boucle continuera jusqu'à ce que la variable 'decalage' soit supérieure à 256.
    liste = decodage2(phrase,decalage) #on utilise la fonction decodage
